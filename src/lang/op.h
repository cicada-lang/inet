...
get_free_wire_op_t *get_free_wire_op_new(const node_spec_t *node_spec, port_index_t index);
...
void get_free_wire_op_destroy(get_free_wire_op_t **self_pointer);
